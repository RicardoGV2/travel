...
for item in all_items:
    ...
    with col2:
        if selected_user == "Shared" or item not in shared_items:
            st.button('❌', key=f'{key_prefix}_button', on_click=delete_item_from_checklist if selected_user != "Shared" else delete_shared_item, args=(selected_user if selected_user != "Shared" else item_name,))
