...
def make_sidebar():
    with st.sidebar:
        ...
        if st.session_state.get("logged_in", False):
            st.button("Secret Company Stuff", on_click=lambda: st.experimental_rerun("pages/page1.py"), key="page1")
            st.button("More Secret Stuff", on_click=lambda: st.experimental_rerun("pages/page2.py"), key="page2")
            ...
            # If anyone tries to access a secret page
